 ...
 *
 * <p>Tests cover construction, adding/removing/finding cards, sorting,
 * counting, querying, string representation, and edge/failure cases.
 * Uses Hamcrest matchers throughout for expressive assertions.</p>
 *
 * @author Poker Demo
 * @version 1.0
 */
...
public class HandTest {
    ...
    private Hand hand; // what we are testing
    ...
    //private Cardi mockCard;
    //cardi for mock
    //redo test interface so that it accepts cardi 
    
    //How do i inject the cards without needing other methods
    ...
    private class TestHand extends Hand{
    	...
    	//... allows as many cards to be implemented as a list
    	public TestHand(Card...tcards) {
    		this.cards = new ArrayList<>(Arrays.asList(tcards));
    	}
    };
    
    
    //everything a hand is + a lil more, added multi parameter constructor 
    //allows mock injection 
    
    //allows multiples of the same thing !!
    /**
    ...
    public void setUp() {
        ...
        mockCard = new Card(4,1) {
        	
        	@Override
        	public int getSuitNum() { return 4; }
        	
        	@Override
        	public int getFaceNum() { return 1; }
        	
        	@Override
        	public String toString() { return "Ace of spades"; }
        	
        	@Override
        	public int compareTo(Card other) {
        		return Integer.compare(this.getFaceNum(), other.getFaceNum());
        	}
      ...
      //Make it so these tests are not dependable on addCard 
    ...
    public void testAddCardIncreasesSize() {
        ...
        //hand.addCard(aceOfSpades); //comment this when figured out.
    ...
    public void testAddMultipleCards() {
        hand = new TestHand(aceOfSpades,kingOfHearts,queenOfDiamonds);

        assertThat(hand.size(), is(3));
        
        //hand = new TestHand(aceofspades,kingofhearts,queenofdiamonds);
        //when this is implemented, you can get rid of the addCards 
        //useful to make sure that we are not dependable on addCard 
        
        //True isolated testing, no temporal coupling. where one method has to work because all the methods depend on it !! 
    ...
    public void testRemoveCardNotFound() {
    	hand = new TestHand(kingOfHearts);
    ...
    public void testRemoveNullCard() {
        hand.removeCard((Card) null);
    }

    @Test
    public void testRemoveCardMatchesExactSuitAndFace() {
    	hand = new TestHand(aceOfSpades);          // Ace of Spades
        Card aceOfHearts = new Card(3, 1);  // Ace of Hearts
    ...
    public void testRemoveCardByIndex() {
        ...
        Card removed = hand.removeCard(0); // remove first
    ...
    public void testSortByRankAscending() {
    	hand = new TestHand(aceOfSpades,kingOfHearts);      // highest rank
