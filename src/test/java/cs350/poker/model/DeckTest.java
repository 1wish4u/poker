...
public class DeckTest {
    ...
    public void testNewDeckContainsCorrectSuits() {
    	...
    	for(int i = 0;i<52;i++) {
    		...
    		switch(c.getSuitNum()) {
    		case Card.CLUBS: clubs++;break;
    		case Card.DIAMONDS: diamonds++;break;
    		case Card.HEARTS : hearts++;break;
    		case Card.SPADES : spades++;break;
    		
    		}
    	}
    		
    		
    		assertThat(clubs,is(13));
    		assertThat(diamonds,is(13));
    		assertThat(hearts,is(13));
    		assertThat(spades,is(13));
    ...
    //reading provide info on how to train them 
    ...
    public void testShuffleWithMockedRandom() {
    	...
    	Deck mockedDeck = new Deck(mockRandom);
    	
    	mockedDeck.shuffle();
    	
    	verify(mockRandom, times(51)).nextInt(anyInt());
    	
    	assertThat(mockedDeck.numCardsLeft(), is(52));
